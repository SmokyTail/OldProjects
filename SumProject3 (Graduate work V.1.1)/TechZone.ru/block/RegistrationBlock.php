<div class="MainInfoDiv">
	...
	<div class="MainInfoText">		
		<form action="block/PHP/UserSaver.php" method="POST" class="">			
			<div class="DivHalf">				
				<div class="Div0x35">
			...
			<div class="Div0x0">				
				<p class="TRegisTrue">					
					<input name="CheckBoxClick" class="CheckBoxClick" type="checkbox"> Нажимая кнопку «Зарегистрироваться», Вы принимаете условия <a class="TARegisTrue" href="#">Пользовательского соглашения</a>.
				</p>					
			</div>
